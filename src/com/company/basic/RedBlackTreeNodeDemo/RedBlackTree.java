package com.company.basic.RedBlackTreeNodeDemo;
...
public class RedBlackTree {
    ...
    public static void main(String[] args) {
        ...
        resursivelyPreTraversal(tree.root);
        System.out.println();
        System.out.println("中序");
        resursivelyInTraversal(tree.root);
        System.out.println();
        System.out.println("后序");
        resursivelyPostTraversal(tree.root);
    }
     ...
     * @param node
     */
    public static void resursivelyPreTraversal(RedBlackTreeNode node){
        if(node == null){
            return;
        }
        String color = "Black";
        ...
        resursivelyPreTraversal(node.getLeft());
        resursivelyPreTraversal(node.getRight());
    }
     ...
     * @param node
     */
    public static void resursivelyInTraversal(RedBlackTreeNode node){
        if(node == null){
            return;
        }
        resursivelyInTraversal(node.getLeft());
        String color = "Black";
        if(isRed(node)){
            color = "Red";
        }
        System.out.print(node.getData()+"(" + color + ") ");
        resursivelyInTraversal(node.getRight());
    }
     ...
     * @param node
     */
    public static void resursivelyPostTraversal(RedBlackTreeNode node){
        if(node == null){
            return;
        }
        resursivelyPostTraversal(node.getLeft());
        resursivelyPostTraversal(node.getRight());
        String color = "Black";
        if(isRed(node)){
            color = "Red";
        }
